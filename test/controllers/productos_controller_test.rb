...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, id: @producto.id, image: @producto.image, name: @producto.name, price: @producto.price }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { description: @producto.description, id: @producto.id, image: @producto.image, name: @producto.name, price: @producto.price }
    assert_redirected_to producto_path(assigns(:producto))
  end
